...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    private TextView timeTV,scoreTV,playerTV;
    private View menu,game;
    private ImageButton playBtn;
    private TextView status, scoreMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scoreMessage=findViewById(R.id.messageText);
        ...
        playBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                playerTV.setText(playerName.getText().toString());
    ...
    //Change the view visibility to gameover
    public void gameOver(String reason){
        ...
        scoreMessage.setText(playerName.getText().toString()+ " score: "+ score);
